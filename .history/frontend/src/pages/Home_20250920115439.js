                    ...
                    <div className="container mx-auto px-4 lg:px-8">
                      <div className="max-w-3xl text-white">
                        ...
                        >
                          ...
                          <p className="text-base md:text-lg mb-8 text-white/80 max-w-2xl leading-relaxed">
                            {slide.description}
                          </p>
          ...
          <section className="py-8">
            <div className="container mx-auto px-4 lg:px-8">
              <motion.div 
                ...
                whileInView="animate"
                viewport={{ once: true }}
                className="bg-gradient-to-r from-pink-500 to-purple-500 rounded-2xl p-6 md:p-8 text-white text-center"
              >
          ...
          <div className="container mx-auto px-4 lg:px-8">
            ...
            >
              {ageGroups.map((group, index) => (
                ...
                >
                  <Link to={group.link}>
                    <div className="relative overflow-hidden rounded-2xl bg-white shadow-lg hover:shadow-xl transition-all duration-500 group-hover:-translate-y-2">
                      {/* Image */}
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4 lg:px-8">
            ...
            >
              <Link
                to="/products"
                className="inline-flex items-center px-8 py-4 bg-pink-500 text-white font-bold rounded-xl hover:bg-pink-600 transition-colors text-lg"
              >
                Xem tất cả sản phẩm
                <FiArrowRight className="ml-2 w-5 h-5" />
              </Link>
                ...
                {categories.slice(0, 6).map((category, index) => (
                  ...
                  >
                    <Link
                      ...
                      className="group block p-6 bg-white rounded-2xl hover:bg-gradient-to-br hover:from-pink-50 hover:to-purple-50 transition-all duration-300 text-center hover:shadow-lg hover:-translate-y-1"
                    >
                      <div className="w-16 h-16 mx-auto mb-4 bg-gray-100 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300 group-hover:bg-white group-hover:shadow-lg">
                        {category.image ? (
                          <img
                            src={category.image}
                            alt={category.name}
                      ...
                      <h3 className="text-sm font-semibold text-gray-700 group-hover:text-pink-600 transition-colors">
                        {category.name}
                      </h3>
                    </Link>
                  </motion.div>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4 lg:px-8">
            <motion.div 
              ...
              whileInView="animate"
              viewport={{ once: true }}
              className="bg-gradient-to-r from-pink-500 to-purple-500 rounded-3xl p-8 md:p-12 text-center text-white"
            >
              <div className="max-w-2xl mx-auto">
                ...
                <form className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
                  ...
                  <button
                    type="submit"
                    className="bg-white text-pink-600 font-bold px-8 py-4 rounded-xl hover:bg-gray-100 transition-colors whitespace-nowrap"
                  >
                    Đăng ký ngay
                  </button>
                </form>
